...
import com.shane.sunshine.data.WeatherContract;
...
import static com.shane.sunshine.data.WeatherContract.WeatherEntry;

/**
 * Created by Shane on 9/5/2016.
 */
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APP_ID_PARAM, mContext.getString(R.string.openweathermap_api_key))
                    .build();
